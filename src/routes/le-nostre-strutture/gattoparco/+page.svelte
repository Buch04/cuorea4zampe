...
<div class="bg-white py-12">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      <h2 class="text-base text-red-600 font-semibold tracking-wide uppercase">Il Nostro Gattoparco</h2>
      <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
        Un'oasi di pace per gatti
      </p>
      <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
        Il gattoparco è un ambiente protetto e stimolante dove i nostri gatti possono vivere in semi-libertà, socializzare tra loro e interagire con i volontari.
      </p>
    </div>
    ...
    <div class="mt-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div class="prose prose-lg text-gray-600">
          <h3>Un ambiente su misura per loro</h3>
          <p>
            Abbiamo creato un'area verde e sicura, recintata e attrezzata per rispondere alle esigenze etologiche dei gatti.
          </p>
          <ul>
        ...
        <div class="mt-8 md:mt-0">
          <img class="w-full rounded-lg shadow-lg" src="/hero-5.jpeg" alt="Gatto che si arrampica su un albero nel gattoparco">
        </div>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mt-12">
        <div class="md:order-2">
          <img class="w-full rounded-lg shadow-lg" src="/hero-4.jpeg" alt="Gatti che si rilassano nel gattoparco">
        </div>
        <div class="prose prose-lg text-gray-600 md:order-1">
          <h3>Socializzazione e benessere</h3>
          <p>
